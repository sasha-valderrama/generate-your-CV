...
export const defaultValues = {
  profile: {
    ...
    email: 'sashimi_jo@gmail.com',
    url: 'github.com/sasha-valderrama',
  },
  about: {
    description:
      'Passionate about accessible Web and user friendly interfaces. I love using brand new technologies and solving bugs on a daily basis.',
  },
  experiences: [
    {
      id: nanoid(5),
